...
%     They are fenced by "<<" and ">>" instead of "{{" and "}}" because braces
%     carry meaning in LaTeX.
...
%     We will draw them by specifying the endpoints of each segment.
...
y label style={at={(ticklabel* cs:<<:ylabelbuffer>>)},
               font=\small,
               anchor=west,
               align=center,
...
every axis legend/.append style={nodes={right}}
    ...
    \addlegendimage{/pgfplots/refstyle=mtr0}
    \addlegendentry{<<:mtrlegendtext>>}

    <<#:d0weights>>
      \addplot[name path=<<pathname>>,
               forget plot,
               color=<<color>>,
               mark=<<mark>>,
               mark size=<<marksize>>,
